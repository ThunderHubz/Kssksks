...
local reroll = createButton("ðŸŽ² Reroll Mutation", 45, Color3.fromRGB(100, 100, 100))
...
button.MouseButton1Click:Connect(function()
	...
	if tool then
		...
		for i = 10, 1, -1 do
			...
			buttonLabel.Text = "â³ Updating in " .. i .. "s..."
		...
		buttonLabel.Text = "âœ… Age Set to 50"
		...
		buttonLabel.Text = "âš ï¸ No Pet Equipped"
